...
export const DEFAULT_DEVICES = {
  tv: {
    description:
      'Television set — for watching content, streaming, and multimedia',
    capabilities: [
  ...
  thermostat: {
    ...
    capabilities: [{ kind: 'property', name: 'temperature', type: 'number' }],
  },
  fan: {
  ...
  nightstand: {
    description:
      'Bedside nightstand — secondary/ambient light, not main illumination',
    capabilities: [
  ...
  switch: {
    description:
      'Generic on/off switch — for simple power control of any device',
    capabilities: [{ kind: 'property', name: 'power', type: 'power' }],
  },
